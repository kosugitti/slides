...
クラスごと・フィールドごとの正答率をプロットすることができます。クラス参照ベクトルClass Reference Vectorと呼ばれます。
...
クラスごと・フィールドごとの正答率をプロットすることができます。この図をフィールド参照プロファイルField Reference Profileといいます。
...
クラスごと・フィールドごとの正答率をプロットすることができます。クラス参照ベクトルランク Reference Vectorと呼ばれます。
...
ランクごと・フィールドごとの正答率をプロットすることができます。この図をフィールド参照プロファイルField Reference Profileといいます。
